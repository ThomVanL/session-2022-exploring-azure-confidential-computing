...
@allowed([
 'Standard_DC2s_v2'   //v2 SKU up to 8 cores
 'Standard_DC2s_v3'   //v3 SKU up to 48 cores (remote storage only)
 'Standard_DC2ds_v3'  //v3 SKU up to 48 cores (with temp storage disk)
])
